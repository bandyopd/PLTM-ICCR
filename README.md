## R programs "Gridsearch.R" and "Optimal.R" conducts sieve MLE estimation under the partially linear transformation generalized odds rate model for interval-censored competing risks data. 
